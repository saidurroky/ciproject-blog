    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-8">
          <h2>User Login</h2>
          <hr />
          <h2 style="color:red"> <?php if($this->session->flashdata('login_failed')): ?>

            <?php echo $this->session->flashdata('login_failed');?>

          <?php endif ;?></h2>
          <form class="form-horizontal" method="post" action="<?php echo base_url();?>User_login_controller/login_information">
