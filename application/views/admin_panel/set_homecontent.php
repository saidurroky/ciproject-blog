  ...
  <body>
   <nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    < <div class="container">
      ...
      <div class="row">
        <div class="col-md-12">
          <h2>Set Home Content</h2>
          <hr />
          <div class="bg-success">
            <?php if($this->session->flashdata('publish_succ')):?>

            <?php echo $this->session->flashdata('publish_succ');?>

            <?php endif;?>

            </div>
          <form class="form-horizontal" method="post" action="<?php echo base_url();?>Admin_controller/save_homecontent">
            ...
            <div class="form-group">
              <label class="control-label col-sm-2" for="content">Home Content:</label>
              <div class="col-sm-10">
