    ...
    < <div class="container">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url();?>Admin_controller/update_aboutus">
            <div class="form-group">
              <label class="control-label col-sm-2" for="title" >Title:</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="title" name="title" value="<?php echo $editaboutus->title ;?>">
                <input type="hidden" class="form-control" name="aboutus_id" value="<?php echo $editaboutus->aboutus_id ;?>">
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-sm-2" for="content">About Us Content:</label>
              <div class="col-sm-10">
                <textarea class="form-control"  name="content" rows="3" id="content" > <?php echo $editaboutus->content ;?> </textarea>
              </div>
            </div>
            <div class="form-group"> 
