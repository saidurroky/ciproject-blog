      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="bg-success">
            ...
            <div class="bg-danger">
            <?php if($this->session->flashdata('publish_err')):?>

            <?php echo $this->session->flashdata('publish_err');?>

            <?php endif;?>
          </div>
          <form class="form-horizontal" method="post" action="<?php echo base_url();?>Admin_controller/saveaboutus">
